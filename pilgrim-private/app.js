...
import * as Utils from './utils.js?v=4.34.7';
import * as Storage from './storage.js?v=4.34.7';
import * as TTS from './tts.js?v=4.34.7';
import * as Sync from './sync.js?v=4.34.7';
import * as StudyTools from './studyTools.js?v=4.34.7';
import * as UI from './ui.js?v=4.34.7';
