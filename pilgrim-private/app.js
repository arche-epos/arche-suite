...
import { mediaInit } from './media.js?v=4.38.2';

import { memWireSync } from './memory.js?v=4.38.2';

// Namespace imports give live bindings for all exports of each module
import * as Utils from './utils.js?v=4.38.2';
import * as Storage from './storage.js?v=4.38.2';
import * as TTS from './tts.js?v=4.38.2';
import * as Sync from './sync.js?v=4.38.2';
import * as StudyTools from './studyTools.js?v=4.38.2';
import * as UI from './ui.js?v=4.38.2';
import * as Media from './media.js?v=4.38.2';
import * as Memory from './memory.js?v=4.38.2';
...
// Scripture Memory (v4.36.0): memory.js can't import sync.js (cycle), so the push trigger is wired here.
memWireSync(function() { syncToGist(true); });
...
[Utils, Storage, TTS, Sync, StudyTools, UI, Media, Memory].forEach(function(mod) {
