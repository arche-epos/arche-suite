...
import { saveStudy, persist, syncFromInputs } from './storage.js?v=4.35.3';
import { syncToGist } from './sync.js?v=4.35.3';
import { _ttsActive, _ttsSource, _ttsIdx, ttsStop } from './tts.js?v=4.35.3';
...
async function _lexFullLookup(query,btn,res,bar){
  ...
  try{
    // v4.35.3 — up to 2 attempts: the model occasionally returns an empty/truncated body
