...
/**
 * Fire-and-forget usage-tracking beacon (added Aug 27 2026, spec-usage-tracking-admin-v2.md).
...
var CHANGELOG=[
  ...
  {
    version:'4.34.37',date:'Sep 14, 2026',label:'',
    _clSectionOpen:false,_clOpen:false,
    items:[
  ...
  {
    version:'4.34.32',date:'Sep 14, 2026',label:'',
    _clSectionOpen:false,_clOpen:false,
    items:[
    ...
    ]},
  {
    ...
    items:[
      ...
      "fix: moved Study Sync (Backup/Restore) to the top of Settings, above Appearance — was previously second."
    ]},
  {
    version:'4.34.9',date:'Sep 12, 2026',label:'',
    _clSectionOpen:false,_clOpen:false,
    items:[
      "fix: renamed the Lexicon Lookup modal and the Study Tools \"Lexicon\" button to \"Look Up Word\" — matches the Notes-screen button that already used plain language, closing a jargon leak the v2 UX audit's term-by-term table hadn't itemized by name. Also updated the Appearance settings description and the AI-result disclaimer text (\"Word lookup data generated by AI\u2026\") to match.",
      "fix: renamed the Study Tools \"Resources\" button and its modal (was \"Study Resources\") to \"Study Helps\" — it opens Bible-study methodology reference material and was sharing a label with the unrelated photo/document capture feature, which had no label of its own. Added a \"Photos & Documents\" section label above the Camera/Gallery/Document row on the Notes screen so the two are no longer confusable.",
      "fix: added an inline \"Sort By:\" label beside the Library sort control and removed the now-redundant \"Sorting Your Library\" guided-tour step explaining it.",
      "fix: removed the \"Progress\" guided-tour step pending a redesign of the Progress view it points at. Tour A is now 25 steps (was 27)."
    ]},
  {
    version:'4.34.8',date:'Sep 11, 2026',label:'',
    _clSectionOpen:false,_clOpen:false,
    items:[
  ...
  {
    version:'4.34.5',date:'Sep 11, 2026',label:'',
    _clSectionOpen:false,_clOpen:false,
    items:[
      "tune: Guided Tour (Tour A) trimmed from 35 steps to 27 — the five header-field steps (Date, Teacher, Series, Title, Tags) are now two steps covering the same fields in logical groups, and the six individual AI-tool steps are now one step introducing all six by name. No coverage lost, same fields and tools are still explained, just grouped instead of one-at-a-time."
    ]},
  {
    version:'4.34.4',date:'Sep 11, 2026',label:'',
    _clSectionOpen:false,_clOpen:false,
    items:[
  ...
  {
    version:'4.28.15',date:'Aug 26, 2026',label:'',
    _clSectionOpen:false,_clOpen:false,
    items:[
  ...
  {
    version:'4.15.3',date:'July 20, 2026',label:'',
    _clSectionOpen:false,_clOpen:false,
